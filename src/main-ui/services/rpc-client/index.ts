...
export const rpcClient = {
  ...
  getUseLocalLLM: (params: EmptyParams): Promise<Result<{ useLocalLLM: boolean }, RpcError>> =>
    request('getUseLocalLLM', params),
  setUseLocalLLM: (params: SetUseLocalLLMParams): Promise<Result<{ success: boolean }, RpcError>> =>
    request('setUseLocalLLM', params),
  ...
  checkOllamaStatus: (params: EmptyParams): Promise<Result<CheckOllamaStatusResponse, RpcError>> =>
    request('checkOllamaStatus', params),
  getOllamaSettings: (params: EmptyParams): Promise<Result<OllamaSettingsResponse, RpcError>> =>
    request('getOllamaSettings', params),
  setOllamaSettings: (
    params: SetOllamaSettingsParams
  ): Promise<Result<{ success: boolean }, RpcError>> => request('setOllamaSettings', params),
};
