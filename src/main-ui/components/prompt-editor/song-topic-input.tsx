    ...
    <div className="space-y-1">
      ...
      {isOverLimit ? (
        <p className="text-micro text-destructive flex items-center gap-1">
          <AlertCircle className="w-3 h-3" /> Song topic exceeds{' '}
          {APP_CONSTANTS.MAX_LYRICS_TOPIC_CHARS} characters.
        </p>
      ) : (
        <p className="ui-helper">
          If provided, lyrics will focus on this topic instead of the musical style description
          above.
        </p>
      )}
    </div>
