...
export const ARTICULATIONS: Record<InstrumentCategory, readonly string[]> = {
  ...
  brass: ['Muted', 'Bold', 'Fanfare', 'Stabs', 'Swells', 'Punchy', 'Warm', 'Bright'],
  woodwind: ['Legato', 'Staccato', 'Soft', 'Bright', 'Warm', 'Solo', 'Ornamented', 'Runs'],
  synth: [
    'Sidechained',
    'Evolving',
    'Plucky',
  ...
  organ: ['Swelling', 'Comping', 'Warm', 'Bright', 'Full', 'Sparse', 'Churchy'],
  percussion: ['Tight', 'Loose', 'Syncopated', 'Soft', 'Driving', 'Minimal', 'Busy', 'Latin'],
} as const;
...
export function getArticulationForInstrument(
  ...
  const category =
    INSTRUMENT_CATEGORIES[instrument.toLowerCase()] || INSTRUMENT_CATEGORIES[instrument];
