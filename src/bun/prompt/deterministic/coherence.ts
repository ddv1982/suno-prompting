...
const CONFLICT_RULES: readonly ConflictRule[] = [
  {
    ...
    instrumentPatterns: ['distorted', 'overdriven', 'fuzz', 'heavy guitar', 'crushing', 'screaming'],
  ...
  },
  {
    ...
    instrumentPatterns: ['acoustic guitar', 'upright bass', 'acoustic piano', 'nylon string', 'ukulele'],
    productionPatterns: ['glitch', 'bitcrushed', 'digital distortion', 'vocoder', 'autotune', 'robotic'],
  },
  {
    id: 'orchestral-lofi',
    description: 'Orchestral instruments with lo-fi production',
    instrumentPatterns: ['symphony', 'orchestra', 'string section', 'philharmonic', 'chamber orchestra', 'full strings'],
    productionPatterns: ['lo-fi', 'vinyl crackle', 'tape hiss', 'dusty', 'bedroom production', 'cassette'],
  },
  {
    id: 'delicate-aggressive',
    description: 'Delicate instruments with aggressive production',
    instrumentPatterns: ['music box', 'celesta', 'harp', 'glockenspiel', 'kalimba', 'wind chimes', 'glass harmonica'],
    productionPatterns: ['crushing', 'aggressive', 'slamming', 'brutal', 'punishing', 'extreme compression'],
  },
  {
