...
// Spatial audio tags
export { SPATIAL_AUDIO_TAGS, selectSpatialTags } from './spatial';

// Harmonic descriptor tags
export { HARMONIC_DESCRIPTORS, selectHarmonicTags } from './harmonic';

// Dynamic range tags
export { DYNAMIC_RANGE_TAGS, selectDynamicTags } from './dynamic';

// Temporal effect tags
export { TEMPORAL_EFFECT_TAGS, selectTemporalTags } from './temporal';

// Texture descriptor tags
export { TEXTURE_DESCRIPTORS, selectTextureTags } from './texture';

// Genre mappings
export { GENRE_ELECTRONIC_RATIO } from './genre-mappings';
...
import {
  VOCAL_PERFORMANCE_TAGS as VOCAL_PERF_TAGS,
  GENRE_VOCAL_PROBABILITY as VOCAL_PROB,
} from './vocal';
