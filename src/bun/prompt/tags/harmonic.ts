...
export const HARMONIC_DESCRIPTORS = {
  ...
  richness: ['harmonic richness', 'overtone emphasis', 'fundamental focus', 'harmonic saturation'],

  /** Frequency balance (4 tags) */
  balance: ['balanced frequency spectrum', 'warm low mids', 'bright high end', 'scooped midrange'],
