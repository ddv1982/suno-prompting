...
export const TEMPORAL_EFFECT_TAGS = {
  /** Timing feel (4 tags) */
  timing: ['swing feel', 'straight time', 'rushed timing', 'laid-back groove'],

  /** Micro-timing (4 tags) */
  microTiming: ['human timing drift', 'quantized precision', 'micro-rubato', 'tight timing'],

  /** Groove (4 tags) */
  groove: ['groove pocket', 'stiff quantization', 'loose feel', 'locked groove'],
} as const;
