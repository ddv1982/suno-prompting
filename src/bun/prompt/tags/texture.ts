...
export const TEXTURE_DESCRIPTORS = {
  /** Polish level (4 tags) */
  polish: ['polished production', 'raw texture', 'demo quality', 'professional sheen'],
  ...
  /** Fidelity (4 tags) */
  fidelity: ['lo-fi dusty', 'hi-fi clarity', 'mid-fi character', 'bootleg quality'],

  /** Organic/synthetic (4 tags) */
  nature: ['organic feel', 'synthetic sheen', 'acoustic authenticity', 'electronic polish'],

  /** Space and depth (4 tags) */
  space: ['layered depth', 'flat 2d mix', 'atmospheric space', 'intimate close-up'],
} as const;
