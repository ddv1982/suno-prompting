export const CROSS_MODE_COMBINATIONS = {
  ...
  lydian_minor: {
    ...
    progressions: ['Imaj7#11 - iv - bVI', 'I - II - bVI - bVII', 'Imaj7#11 - bVII - iv - I'],
  ...
  lydian_major: {
    ...
    progressions: ['Imaj7#11 - IV - V - I', 'I - II - IV - I', 'Imaj7 - II/I - IV - V'],
  ...
  dorian_lydian: {
    ...
    progressions: ['i7 - IV7#11', 'i - II7 - IV - bVII', 'i7 - IV7 - Imaj7#11 - iv'],
  ...
  harmonic_major: {
    ...
    progressions: ['i - V7 - bVI - V7 - I', 'i - iv - V7 - I', 'i - bVI - V7 - I'],
  ...
  phrygian_major: {
    ...
    progressions: ['i - bII - V - I', 'i - bII - bVII - I', 'i - iv - bII - I'],
...
export const WITHIN_MODE_COMBINATIONS = {
  minor_journey: {
    ...
    progressions: ['i - iv - V7 - i', 'i - bVI - V7 - i(maj7)', 'i - iv - V7 - i - i(maj7)'],
  ...
  major_modes: {
    ...
    progressions: ['Imaj7#11 - IV - V - I7', 'I - II - IV - bVII', 'Imaj7#11 - IV - I - bVII'],
  ...
  dark_modes: {
    ...
    progressions: ['i - bII - i°', 'i - bVI - bII - i°', 'i - iv - bII - i°'],
