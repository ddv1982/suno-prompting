 ...
 */
export const FullPromptSubmitSchema = z.object({
 ...
 */
export const FullPromptRefineSchema = z.object({
 ...
 */
export const QuickVibesSubmitSchema = z.object({
 ...
 * QuickVibesCategorySchema to allow any string category value.
 */
export const QuickVibesRefineSchema = z.object({
  category: z.string().nullable(),
  customDescription: z.string(),
  sunoStyles: SunoStylesSchema,
  original: z.object({
  ...
  const descriptionChanged = data.customDescription.trim() !== data.original.customDescription.trim();
 ...
 */
export const CreativeBoostSubmitSchema = z.object({
  description: z.string(),
  lyricsTopic: z.string(),
  lyricsMode: z.boolean(),
  sunoStyles: SunoStylesSchema,
